...
use drt_game_sc::game_proxy;

const GAME_SC_PATH: DrtscPath = DrtscPath::new("output/drt-game-sc.drtsc.json");
...
const GAME_SC_ADDR: TestSCAddress = TestSCAddress::new("drt_game_sc");

fn world() -> ScenarioWorld {
    let mut blockchain = ScenarioWorld::new();

    blockchain.register_contract(GAME_SC_PATH, drt_game_sc::ContractBuilder);
    blockchain
}
