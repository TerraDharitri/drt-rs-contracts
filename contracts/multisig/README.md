...
The release version v1.6.4 of drt-rs-contracts, contains the audited of for the multisig contract. It can be found here: https://github.com/dharitri/drt-rs-contracts/releases/tag/v1.6.4
